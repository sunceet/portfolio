        ...
        >
          ...
          <div className="bg-zinc-900/50 rounded-xl p-6 sm:p-8 space-y-4 text-zinc-300 leading-loose">
            ...
            <p>
              ...
              по направлению «Инженерная школа информационных систем и
              технологий» с присвоением квалификации бакалавра. Полученное
              техническое образование дало мне фундаментальные знания в области
              программной инженерии, архитектуры систем и алгоритмов, которые я
              успешно применяю в коммерческой разработке.
            </p>
          </div>
        </motion.section>
